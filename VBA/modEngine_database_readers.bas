...
Public Function PanelModel(ByVal PanelID As String) As String
    ...
    PanelModel = ReadStringFromEngine(status, buf, "PanelModel")
End Function
...
Public Function PanelManufacturer(ByVal PanelID As String) As String
    ...
    InitializeEngine
    buf = String$(SDEP_STRING_BUFFER_LEN, vbNullChar)
    status = sdep_get_panels_manufacturer(PanelID, buf, Len(buf))
    PanelManufacturer = ReadStringFromEngine(status, buf, "PanelManufacturer")
End Function
